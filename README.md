...
本固件已默认将 Nikki 的 GeoIP 和 UI 下载地址设置为代理地址，解决国内无法直连 GitHub 的问题。

**默认配置（无需手动修改）：**
- **GeoIP(MMDB) 下载地址**：`https://gh-proxy.com/https://github.com/MetaCubeX/meta-rules-dat/releases/download/latest/country-lite.mmdb`
- **zashboard UI 文件下载**：`https://gh-proxy.com/https://github.com/Zephyruso/zashboard/releases/latest/download/dist-cdn-fonts.zip`

如需修改，可在 LuCI → 服务 → Nikki → Mixin 设置中调整。
